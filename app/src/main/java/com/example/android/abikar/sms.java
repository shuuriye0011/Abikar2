...
EditText message,phone;
    ...
    public void sendsms(String pho,String mes){
        try {
            ...
            Toast.makeText(getApplicationContext(),"Your Message Has been Sendt",Toast.LENGTH_LONG).show();
        } catch (Exception e) {
     ...
     switch (requestCode){
         case 1:{
             if (grantResults.length < 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                 if(ContextCompat.checkSelfPermission(sms.this,Manifest.permission.READ_PHONE_STATE)==PackageManager.PERMISSION_GRANTED){
